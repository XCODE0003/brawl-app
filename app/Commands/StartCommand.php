...
class StartCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->replyWithMessage(['text' => '<b>🎉Добро пожаловать🎉</b><br><br>Это первый бот в телеграм по игре Brawl Stars, позволяющий тебе получить донат за клики! <br><br>Прокачивай бусты, зови друзей, копи монеты Brawl Coin и забирай призы уже сегодня!<br><br><b>👇Нажимай на кнопку играть и начинай тапать прямо сейчас</b>', 'reply_markup' => json_encode($keyboard), 'parse_mode' => 'HTML']);
    }
}
